...
El problema central resuelto por la tecnología Blockchain,  es lograr y mantener la integridad en un sistema punto a punto puramente distribuido que se compone de un número desconocido de pares con confiabilidad desconocida.
